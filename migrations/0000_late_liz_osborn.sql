...
ALTER TABLE "borrow_records" ADD CONSTRAINT "borrow_records_book_id_users_id_fk" FOREIGN KEY ("book_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;